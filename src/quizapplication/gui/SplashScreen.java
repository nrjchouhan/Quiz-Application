...
public class SplashScreen extends javax.swing.JFrame {
    ...
    class SplashThread extends Thread
    {
       public void run ()
       {
           ...
           while(jProgressBar1.getValue()<jProgressBar1.getMaximum())
           {
               ...
               {
                   JOptionPane.showMessageDialog(null, "Exception in thread"+i, "Exception!", JOptionPane.ERROR_MESSAGE);
               }
           }
           dispose();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/quizapplication/gui/Splash.png"))); // NOI18N
